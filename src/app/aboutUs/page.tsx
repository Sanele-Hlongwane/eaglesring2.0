            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <div className="mb-6">
                ...
                <p className="text-lg lg:text-xl text-black leading-relaxed">
                  At Eagles Ring, our mission is to bridge the gap between innovative entrepreneurs and visionary investors. We provide a platform where entrepreneurs can present their groundbreaking ideas to a panel of experienced business moguls, known as the &quot;Eagles.&rdquo;
 Our goal is to foster entrepreneurship and drive economic growth by facilitating access to capital and mentorship.
                </p>
              </div>
              <div className='mb-6'>
